  ...
  return (
    <View style={styles.container}  onPress={()=>showModal(true)}>
      ...
      <View style={{ display: "flex", flexDirection: "row",gap:19, }}>
        <TouchableOpacity style={{backgroundColor:colors.Imagecolor,borderRadius:32,height:44,width:153,flexDirection:"row",alignItems: 'center',justifyContent:"center",}} onPress={()=>navigation.navigate("deposit")}>
          <Text style={{color:colors.Orange,textAlign:"center"}}>Add Money</Text>
          <AntDesign name="plus" size={18} color={colors.Orange} />
        </TouchableOpacity>
        <TouchableOpacity style={{backgroundColor:colors.Imagecolor,borderRadius:32,height:44,width:153,flexDirection:"row",alignItems: 'center',justifyContent:"center",}} onPress={()=>navigation.navigate("transfer")} >
