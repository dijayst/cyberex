...
<View style={{ backgroundColor:colors.background,padding:39,flex:1}}>
      <View style={{justifyContent:"center",alignItems:"center",marginTop:60}}>
      <Text style={{fontSize:16,fontWeight:"700",lineHeight:21.6,color:"#000000"}}>Trade Giftcard</Text>
      </View>
      
      <View style={{backgroundColor:colors.background,height:320,width:350,marginLeft:-15,alignItems: 'center',justifyContent:"center",marginTop:161,gap:24}}>
